...
Report.propTypes = {
    aylik : PropTypes.string.isRequired,
    haftalik : PropTypes.string.isRequired,
    bekleyen_gorev : PropTypes.number.isRequired,
    onaylanan_istek : PropTypes.number.isRequired
}
