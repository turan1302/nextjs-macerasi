...
use App\Http\Requests\api\todos\TodoUpdateRequest;
...
class indexController extends BaseController
{
    ...
    public function edit(int $id)
    {
        ...
        if (!$control){
            ...
            return parent::success("Kayıt Getirildi",$control);
        }
    }
    ...
    public function update(TodoUpdateRequest $request,int $id)
    {
        ...
        if (!$control){
            ...
            $result = TodoModel::where("td_id",$id)->update($data);

            if ($result){
                return parent::success("Kayıt başarıyla güncellendi");
            }else{
                return parent::error("Kayıt güncellenirken hata oluştu.",[],500);
            }
        }
    }
